...
//             speed: 450,
//           }}
//           className="bg-tertiary p-4 rounded-[20px] shadow-card py-5 px-12 min-h-[280px] flex justify-evenly item-center flex-col"
//         >
//           <img src={icon} alt={title} className="w-16 h-16 object-contain" />
//           <h3 className="text-white text-[20px] font-bold center">{title}</h3>
//         </div>
//       </motion.div>
//     </Tilt>
//   );
